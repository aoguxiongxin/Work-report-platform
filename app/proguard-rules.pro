...
# in F:\Android\adt-bundle-windows\sdk/tools/proguard/proguard-android.txt
...
#bean类
-keep class atest.test.com.app.model.bean.** {*;}
-keep class atest.test.com.app.constant.**{*;}
-keep interface atest.test.com.app.constant.** {*;}
