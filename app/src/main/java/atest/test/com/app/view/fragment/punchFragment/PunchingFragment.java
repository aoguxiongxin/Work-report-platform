...
import static atest.test.com.app.constant.BaseMessage.USER_MESSAGE;
import static atest.test.com.app.view.activity.MainActivity.NETWORK_STATE_BOOLEAN;
import static atest.test.com.app.view.activity.MainActivity.NETWORK_STATE_NAME;
...
//                                            loginPresenter.checkUserMessage(BaseMessage.NUMBERPHONE, nameEditText.getText().toString().trim(), typeId, v + "," + v1, remark.getText().toString().trim());
                                            loginPresenter.checkUserMessage("13001077225", nameEditText.getText().toString().trim(), typeId, v + "," + v1, remark.getText().toString().trim());
                                        }
                                    });
                                } else {
