...
public class ReportReceiveExAdapter extends BaseExpandableListAdapter {
    ...
    private ReportMyLowerBean.ObjectBean.ReportlogviewBean[][] child;
    ...
    private void initData() {
        ...
        child = new ReportMyLowerBean.ObjectBean.ReportlogviewBean[groupList.size()][];
        ...
        for (int i = 0; i < group.length; i++) {
            ...
            ReportMyLowerBean.ObjectBean.ReportlogviewBean[] childStr = new ReportMyLowerBean.ObjectBean.ReportlogviewBean[childList.size()];
