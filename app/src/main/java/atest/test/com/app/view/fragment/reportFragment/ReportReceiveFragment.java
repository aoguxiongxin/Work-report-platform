...
import atest.test.com.app.presenter.report.ReportMyLowerPresenter;
import atest.test.com.app.view.activity.ReprotHackfanActivity;
import atest.test.com.app.view.adapter.ReportReceiveExAdapter;
...
public class ReportReceiveFragment extends BaseFragment implements View.OnClickListener, ReportMyLowerLogView {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(userInfo.getId())) {
            //调用接口查询
            presenter.getMylowerReportLog(userInfo.getId());
        } else {
