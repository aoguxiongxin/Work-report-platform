...
public class ReportLowarHackfanAdapter extends RecyclerView.Adapter<ReportLowarHackfanAdapter.MyLowarViewHolder> {
    private Context context;
    private List<ReportHackfanMyLowarBean.ObjectBean> list;

    public ReportLowarHackfanAdapter(Context context, List<ReportHackfanMyLowarBean.ObjectBean> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public MyLowarViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.punch_my_item, parent, false);
        return new MyLowarViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyLowarViewHolder holder, final int position) {
        setHeadImg(holder.myImg);

        holder.myType.setText(list.get(position).getSendname());
    ...
    class MyLowarViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyLowarViewHolder(View itemView) {
            super(itemView);
    ...
    public void setOnItemClickListener(ReportLowarHackfanAdapter.onItemClickListener onItemClickListener) {
